            ...
            {differentials.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-luxury-gold via-luxury-gold-light to-luxury-gold flex items-center justify-center shadow-lg group-hover:shadow-[0_0_20px_hsl(38_70%_55%/0.4)] transition-all duration-300">
